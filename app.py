...
try:
    ...
    logging.error("Error please check streamlit is properly imported")
...
try:
    ...
    logging.error('Error in containers or could be error in defination of variables/initializers')   
