...
with prediction:
    ...
    if pay6=='pay duly':
        ...
        pay6_chooser=9
    bill_amt1=st.sidebar.number_input(label=' Bill Amount  Statement  of month September',min_value=0,max_value=1000000,format='%d')
    bill_amt2=st.sidebar.number_input(label=' Bill Amount  Statement  of month August',min_value=0,max_value=1000000,format='%d')
    bill_amt3=st.sidebar.number_input(label=' Bill Amount  Statement  of month July',min_value=0,max_value=1000000,format='%d')
    bill_amt4=st.sidebar.number_input(label=' Bill Amount  Statement  of month June',min_value=0,max_value=1000000,format='%d')
    bill_amt5=st.sidebar.number_input(label=' Bill Amount  Statement  of month May',min_value=0,max_value=1000000,format='%d')
    bill_amt6=st.sidebar.number_input(label=' Bill Amount  Statement  of month April',min_value=0,max_value=1000000,format='%d')
    pay_amt1=st.sidebar.number_input(label=' Pay Amount  Statement  of month September',min_value=0,max_value=1000000,format='%d')
    pay_amt2=st.sidebar.number_input(label=' Pay Amount  Statement  of month August',min_value=0,max_value=1000000,format='%d')
    pay_amt3=st.sidebar.number_input(label=' Pay Amount  Statement  of month July',min_value=0,max_value=1000000,format='%d')
    pay_amt4=st.sidebar.number_input(label=' Pay Amount  Statement  of month June',min_value=0,max_value=1000000,format='%d')
    pay_amt5=st.sidebar.number_input(label=' Pay Amount  Statement  of month May',min_value=0,max_value=1000000,format='%d')
    pay_amt6=st.sidebar.number_input(label=' Pay Amount  Statement  of month April',min_value=0,max_value=1000000,format='%d')
